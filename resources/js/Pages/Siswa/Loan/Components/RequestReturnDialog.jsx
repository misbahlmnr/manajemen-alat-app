...
export default function RequestReturnDialog({
    open,
    onOpenChange,
    itemName,
    requiresInspection,
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                    Ajukan pengembalian untuk{" "}
                    <strong className="text-foreground">{itemName}</strong>.
                    {requiresInspection
                        ? " Admin akan melakukan inspeksi kelengkapan alat."
                        : " Stok akan dikembalikan setelah diproses admin."}
                </p>
                <div className="mt-4 space-y-2">
                    ...
                    <textarea
                        ...
                        placeholder="Kondisi alat saat dikembalikan..."
                    />
                </div>
                <div className="mt-6 flex justify-end gap-2">
                    ...
                    >
                        {loading ? "Mengirim..." : "Ajukan Pengembalian"}
                    </Button>
                </div>
            </div>
        </div>
